...
$(function(){
		...
		$.ajax({
			...
			success : function(jsonData){
				...
				$("#d2").html("번호 : " + jsonData.no + 
						"<br>제목 : " + decodeURIComponent(jsonData.title.replace(/\+/g, " ")) + 
	...
	$("#test3").on("click", function(){
		//컨트롤러에서 list를 json 배열로 받아서 출력 처리
		$.ajax({
			url: "test3.do",
			type: "post",
			dataType: "json",
			success: function(obj){
				console.log(obj); //object 라고 출력
	...
	$("#test4").on("click", function(){
		//컨트롤러에서 Map 객체를 JsonView 를 이용해서 내보낸(리턴한) json 객체 출력 처리
		$.ajax({
			url: "test4.do",
			type: "post",
			dataType: "json",
			success: function(jsonObj){
				...
				$("#d4").html("받은 Map 안의 객체 정보 확인 <br>"
						+ "이름 : " + decodeURIComponent(jsonObj.hashMap.samp.name)
	...
	$("#test5").on("click", function(){
		//자바스크립트 또는 제이쿼리에서 json 객체 만들어서 컨트롤러로 보내기
		var job = new Object();
		job.name = "강감찬";
		job.age = 33;
...
<p><div id="d1"></div></p></li>
<li>컨트롤러로부터 json 객체 받아서 출력 &nbsp;
<button id="test2">테스트2</button>
<p><div id="d2"></div></p></li>
<li>컨트롤러로부터 json 배열 받아서 출력 &nbsp;
<button id="test3">테스트3</button>
<p><div id="d3"></div></p></li>
<li>컨트롤러로부터 맵(Map) 객체 받아서 출력 &nbsp;
<button id="test4">테스트4</button>
<p><div id="d4"></div></p></li>
<li>컨트롤러에 json 객체 보내기 &nbsp;
<button id="test5">테스트5</button>
<p><div id="d5"></div></p></li>
<li>컨트롤러에 json 배열 보내기 &nbsp;
<button id="test6">테스트6</button>
<p><div id="d6"></div></p></li>
