 ...
 */
@WebServlet("/bsearchd")
public class BoardSearchDateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public BoardSearchDateServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// 페이지별로 출력되는 게시글 작성날짜 검색 처리용 컨트롤러
		// 출력될 페이지 기본값 지정
		...
		// 현재 페이지에 출력할 목록 조회
		ArrayList<Board> list = bservice.boardSearchDate(new SearchDate(begin, end), currentPage, limit);
