...
<table width="650" align="center">
	<tr height="40">
		<th width="150">아이디</th>
		<td><input type="text" name="userid" readonly value="<%= member.getUserId()%>"> 
		</td>
	</tr>
	<tr height="40">
		<th width="150">이 름</th>
		<td><input type="text" name="username" readonly value="<%= member.getUserName()%>"></td>
	</tr>
	<tr height="40">
		<th width="150">암 호</th>
		<td><input type="password" id="userpwd1" name="userpwd" value="<%= member.getUserPwd()%>"></td>
	</tr>
	<tr height="40">
		<th width="150">암호확인</th>
		<td><input type="password" id="userpwd2" value="<%= member.getUserPwd()%>"></td>
	</tr>
	<tr height="40">
		<th width="150">성 별</th>
		<td>
	...
	<tr height="40">
		<th width="150">나 이</th>
		<td>
			<input type="number" name="age" min="20" max="100" value="<%= member.getAge()%>">
		</td>
	</tr>
	<tr height="40">
	...
	<tr height="40">
		...
		<td><textarea name="etc" rows="3" cols="30"><%= member.getEtc()%></textarea></td>
	</tr>
	<tr height="40">
		<th colspan="2">
