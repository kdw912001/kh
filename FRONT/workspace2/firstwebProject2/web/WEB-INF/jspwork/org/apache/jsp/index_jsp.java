 ...
 * Generated at: 2019-03-18 12:10:48 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/common/header.jsp", Long.valueOf(1551700684139L));
    _jspx_dependants.put("/views/common/footer.jsp", Long.valueOf(1551698685216L));
    _jspx_dependants.put("/views/common/adminHeader.jsp", Long.valueOf(1551703262441L));
  }
 ...
 if(loginUser != null){ 
      ...
      out.write("\t\t\t\t\t\t+ \"</td><td><a href='/first/bdetail?bnum=\" +json.list[i].bnum+\"&page=1'>\" + decodeURIComponent(json.list[i].btitle).replace(/\\+/gi,\" \")\r\n");
 ...
 if(loginUser != null){ 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\"</td><td><a href='/first/ndetail?no=\" + json.list[i].no + \"'>\" + decodeURIComponent(json.list[i].ntitle).replace(/\\+/gi,\" \") +\r\n");
 ...
 if(loginUser == null){ //로그인 하지 않은 상태 
      out.write("\r\n");
      out.write("<div>\r\n");
      out.write("<form action=\"/first/login\" method=\"post\"><!-- /login이라는 가짜주소로 form태그의 정보를 전송 -->\r\n");
      out.write("<table>\r\n");
      out.write("<tr>\r\n");
      out.write("<th>아이디 : </th>\r\n");
