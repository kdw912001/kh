 ...
 */
@WebServlet("/bsearchw")
public class freeBoardSearchWriterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public freeBoardSearchWriterServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//현재 페이지에 출력할 목록 조회
		ArrayList<FreeBoard> list = bservice.boardSearchWriter(writer, currentPage, limit);
