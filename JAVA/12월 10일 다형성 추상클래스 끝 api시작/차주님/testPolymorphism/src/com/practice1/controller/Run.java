...
import com.practice1.model.vo.Favorite;
import com.practice1.model.vo.MyInfo;
import com.practice1.model.vo.Stuff;

public class Run {

	public static void main(String[] args) {
		MyInfo mi[] = new MyInfo[6];
		mi[0] = new Stuff("홍길동", 19,"세이코", "갤럭시 노트2", 4);
		mi[1] = new Stuff("유관신", 20,"롤렉스", "아이폰7", 3);
		mi[2] = new Stuff("이순선", 22,"다이브", "갤럭시8", 5);
		mi[3] = new Favorite("장발쟝", 25, "하이킹", 3, "사과");
