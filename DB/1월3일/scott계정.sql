...
SELECT ENAME 사원명, EXTRACT(YEAR FROM HIREDATE) 입사년도, EXTRACT(MONTH FROM HIREDATE) 입사한월
--TO_CHAR(HIREDATE,'YYYY"년"MM"월"') 입사일
FROM EMP;
...
--WHERE TO_NUM(SUBSTR(HIREDATE, 5))=9;
