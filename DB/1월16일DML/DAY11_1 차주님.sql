...
-- 컬럼이 현재 NULL 을 사용할 수 있는 상태에서 NULL 을 사용 못 하게 바꾸는 것임
...
DISABLE CONSTRAINT FK_MGRID;  -- DDL 구문 실행 : 새 트랜잭션 시작됨
...
--FROM USER_CONSTRAINTS
--WHERE CONSTRAINT_NAME = 'SYS_C007113';
--
