...
-- 컬럼명 < ANY (다중행 서브쿼리) : 서브쿼리 값들 중에 최대값보다 작으냐?
...
-- ORDER BY 절, INSERT 문, UPDATE 문, CREATE TABLE 문
-- CREATE VIEW 문
...
다중열 다중행 서브쿼리 : 결과값이 항목 여러 개, 값 여러행
