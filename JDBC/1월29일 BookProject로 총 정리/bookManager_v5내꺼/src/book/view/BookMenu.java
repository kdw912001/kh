...
public class BookMenu {
	...
	public void displayMenu() {
		...
		do {
			...
			case 2 : bcontroll.updateBook(modifyBook()); break;
			case 3 : bcontroll.deleteBook(inputBookId()); break;
			case 4 : bcontroll.searchBook(inputBookId());break;
			case 5 : bcontroll.searchBookList(inputBookTitle());break;
			case 6 : bcontroll.searchBookMap(inputBookTitle());break;
	...
	private String inputBookTitle() {
		...
		//도서 입력 부분에서 엔터를 버퍼로 읽어들일 수 있기 때문에 엔터키 제거
	...
	public void printList(ArrayList<Book> bookList) {
		System.out.println("\n조회된 도서의 수 : " + bookList.size());
		for(Book book : bookList)
			System.out.println(book);
	}
	
	public void printMap(HashMap<Integer, Book> bookMap) {
		System.out.println("\n조회된 도서의 수 : " + bookMap.size());
		Iterator<Integer> keyIter = bookMap.keySet().iterator();
