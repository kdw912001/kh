...
INSERT INTO BOOK VALUES(SEQ_BID.NEXTVAL, '자바자료구조', '홍길동', '한빛', TO_DATE('17/09/28', 'RR/MM/DD'), 25000);
INSERT INTO BOOK VALUES(SEQ_BID.NEXTVAL, '초보자를 위한 자바', '이순신', '정보문화사', TO_DATE('18/07/15', 'RR/MM/DD'), 25200);
INSERT INTO BOOK VALUES(SEQ_BID.NEXTVAL, '자바입문', '김유신', '프리렉', TO_DATE('12/02/10', 'RR/MM/DD'), 20000);
INSERT INTO BOOK VALUES(SEQ_BID.NEXTVAL, '자바디자인패턴', '김춘추', '프리렉', TO_DATE('11/09/01', 'RR/MM/DD'), 27000);
INSERT INTO BOOK VALUES(SEQ_BID.NEXTVAL, '자바시큐어코딩', '유관순', '인피니티', TO_DATE('17/06/25', 'RR/MM/DD'), 22500);
